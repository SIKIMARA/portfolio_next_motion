    ...
    <motion.div 
      ...
      className='flex flex-col justify-center items-center w-11/12  bg-white rounded-lg shadow-2xl shadow-black p-2 pb-10 mx-auto my-10'>
        ...
        <div className='flex flex-col md:flex-row justify-around items-center w-full'>
            ...
            <div className='flex flex-col md:flex-row justify-center md:space-x-3 items-center w-full my-5'>
            ...
            {img!=null ? <Image src={img} width="600" height="200"  /> : <ReactPlayer url={videoDemo} muted={true} playing={true} width={"100%"}  /> } 
            </div>
